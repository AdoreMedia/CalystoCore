...
namespace PrivredniDatabases.PrivredniApp.Database
{
	...
	public partial class dbPrivredniAppBaseDataContext : DbContext
	{
		...
		public virtual DbSet<tblDirGeolocation> tblDirGeolocation { get; set; }
		...
		protected override void OnModelCreating(ModelBuilder modelBuilder)
		{
			...
			this.Map_tblDirGeolocation(modelBuilder);
			this.Customize_tblDirGeolocation(modelBuilder);
		...
		private void Map_tblBankaValutaTecaj(ModelBuilder modelBuilder)
		{
			...
			modelBuilder.Entity<tblBankaValutaTecaj>().Property(x=>x.BankaValutaID).HasColumnName("BankaValutaID").HasColumnType("Int").IsRequired().ValueGeneratedNever();
			modelBuilder.Entity<tblBankaValutaTecaj>().Property(x=>x.BrojTecajnice).HasColumnName("BrojTecajnice").HasColumnType("Int").ValueGeneratedNever();
		...
		private void Map_tblDirClientBlacklist(ModelBuilder modelBuilder)
		{
			...
			modelBuilder.Entity<tblDirClientBlacklist>().HasNoKey();
			modelBuilder.Entity<tblDirClientBlacklist>().Property(x=>x.PorezniBroj).HasColumnName("PorezniBroj").HasColumnType("VarChar(20)").ValueGeneratedNever().HasMaxLength(20);
		...
		private void Map_tblDirClientPhone(ModelBuilder modelBuilder)
		{
			...
			modelBuilder.Entity<tblDirClientPhone>().HasKey(x=>x.DirClientPhoneID);
			modelBuilder.Entity<tblDirClientPhone>().Property(x=>x.DirClientPhoneID).HasColumnName("DirClientPhoneID").HasColumnType("BigInt").IsRequired().ValueGeneratedOnAdd();
			modelBuilder.Entity<tblDirClientPhone>().Property(x=>x.DirClientID).HasColumnName("DirClientID").HasColumnType("BigInt").IsRequired().ValueGeneratedNever();
		...
		#region tblDirGeolocation
		private void Map_tblDirGeolocation(ModelBuilder modelBuilder)
		{
			modelBuilder.Entity<tblDirGeolocation>().ToTable("tblDirGeolocation", "dbo");
			modelBuilder.Entity<tblDirGeolocation>().HasKey(x=>x.GeolocationID);
			modelBuilder.Entity<tblDirGeolocation>().Property(x=>x.GeolocationID).HasColumnName("GeolocationID").HasColumnType("BigInt").IsRequired().ValueGeneratedOnAdd();
			modelBuilder.Entity<tblDirGeolocation>().Property(x=>x.drzava).HasColumnName("drzava").HasColumnType("NVarChar(50)").ValueGeneratedNever().HasMaxLength(50);
			modelBuilder.Entity<tblDirGeolocation>().Property(x=>x.mjesto).HasColumnName("mjesto").HasColumnType("NVarChar(200)").ValueGeneratedNever().HasMaxLength(200);
			modelBuilder.Entity<tblDirGeolocation>().Property(x=>x.ulica).HasColumnName("ulica").HasColumnType("NVarChar(200)").ValueGeneratedNever().HasMaxLength(200);
			modelBuilder.Entity<tblDirGeolocation>().Property(x=>x.GeoComponentType).HasColumnName("GeoComponentType").HasColumnType("TinyInt").ValueGeneratedNever();
			modelBuilder.Entity<tblDirGeolocation>().Property(x=>x.GeoPrecisionType).HasColumnName("GeoPrecisionType").HasColumnType("TinyInt").ValueGeneratedNever();
			modelBuilder.Entity<tblDirGeolocation>().Property(x=>x.formattedAddress).HasColumnName("formattedAddress").HasColumnType("NVarChar(400)").ValueGeneratedNever().HasMaxLength(400);
			modelBuilder.Entity<tblDirGeolocation>().Property(x=>x.Latitude).HasColumnName("Latitude").HasColumnType("Decimal(18,10)").ValueGeneratedNever().HasMaxLength(18);
			modelBuilder.Entity<tblDirGeolocation>().Property(x=>x.Longitude).HasColumnName("Longitude").HasColumnType("Decimal(18,10)").ValueGeneratedNever().HasMaxLength(18);
			modelBuilder.Entity<tblDirGeolocation>().Property(x=>x.GeoStatus).HasColumnName("GeoStatus").HasColumnType("Int").ValueGeneratedNever();
			modelBuilder.Entity<tblDirGeolocation>().Property(x=>x.LastUpdateDate).HasColumnName("LastUpdateDate").HasColumnType("SmallDateTime").ValueGeneratedNever();
		}

		partial void Customize_tblDirGeolocation(ModelBuilder modelBuilder);
		#endregion
		...
		private void RelationshipsMapping(ModelBuilder modelBuilder)
		{
			...
			modelBuilder.Entity<tblBankaValuta>().HasMany(x=>x.tblBankaValutaTecajList).WithOne(x=>x.tblBankaValuta).HasForeignKey(x=>x.BankaValutaID).IsRequired(true);

			modelBuilder.Entity<tblBankaValutaTecaj>().HasOne(x=>x.tblBankaValuta).WithMany(x=>x.tblBankaValutaTecajList).HasForeignKey(x=>x.BankaValutaID).IsRequired(true);
			...
			modelBuilder.Entity<tblDirClient>().HasOne(x=>x.tblDirClientFullText).WithOne(x=>x.tblDirClient).HasForeignKey<tblDirClientFullText>(x=>x.DirClientID).IsRequired(true);
			...
			modelBuilder.Entity<tblDirClient>().HasMany(x=>x.tblDirClientPhoneList).WithOne(x=>x.tblDirClient).HasForeignKey(x=>x.DirClientID).IsRequired(true);
			...
			modelBuilder.Entity<tblDirClient>().HasOne(x=>x.tblDirClientPrikazStatus).WithOne(x=>x.tblDirClient).HasForeignKey<tblDirClientPrikazStatus>(x=>x.DirClientID).IsRequired(true);

			modelBuilder.Entity<tblDirClientFullText>().HasOne(x=>x.tblDirClient).WithOne(x=>x.tblDirClientFullText).HasForeignKey<tblDirClient>(x=>x.DirClientID).IsRequired(true);
			...
			modelBuilder.Entity<tblDirClientPhone>().HasOne(x=>x.tblDirClient).WithMany(x=>x.tblDirClientPhoneList).HasForeignKey(x=>x.DirClientID).IsRequired(true);
			...
			modelBuilder.Entity<tblDirClientPrikazStatus>().HasOne(x=>x.tblDirClient).WithOne(x=>x.tblDirClientPrikazStatus).HasForeignKey<tblDirClient>(x=>x.DirClientID).IsRequired(true);
	...
	public partial class tblBankaValuta : EFCoreEntityBase<tblBankaValuta>
	{
		...
		/// <summary>
		/// Association <br/>
		/// [PK][One]tblBankaValuta.BankaValutaID --- [FK][Many]tblBankaValutaTecaj.BankaValutaID <br/>
		/// DeleteRule = NoAction <br/>
		/// </summary>
		public virtual List<tblBankaValutaTecaj> tblBankaValutaTecajList { get; set; } = new List<tblBankaValutaTecaj>();
		#endregion Associations
	...
	public partial class tblBankaValutaTecaj : EFCoreEntityBase<tblBankaValutaTecaj>
	{
		...
		/// <summary>
		/// Association <br/>
		/// [FK][Many]tblBankaValutaTecaj.BankaValutaID --- [PK][One]tblBankaValuta.BankaValutaID <br/>
		/// </summary>
		public virtual tblBankaValuta tblBankaValuta { get; set; }
		#endregion Associations
	...
	public partial class tblDirClient : EFCoreEntityBase<tblDirClient>
	{
		...
		/// <summary>
		/// Association <br/>
		/// [PK][One]tblDirClient.DirClientID --- [FK][Many]tblDirClientPhone.DirClientID <br/>
		/// DeleteRule = NoAction <br/>
		/// </summary>
	...
	public partial class tblDirClientPhone : EFCoreEntityBase<tblDirClientPhone>
	{
		...
		/// DbType = "BigInt NOT NULL IDENTITY", IsPrimaryKey = true, IsDbGenerated = true, AutoSync = AutoSync.OnInsert
		/// </summary>
		public long DirClientPhoneID { get; set; }
		...
		/// <summary>
		/// Association <br/>
		/// [FK][Many]tblDirClientPhone.DirClientID --- [PK][One]tblDirClient.DirClientID <br/>
		/// </summary>
		public virtual tblDirClient tblDirClient { get; set; }
		#endregion Associations
	...
	#region dbo.tblDirGeolocation
	public partial class tblDirGeolocation : EFCoreEntityBase<tblDirGeolocation>
	{
		public tblDirGeolocation()
		{
			OnCreated();
		}

		public tblDirGeolocation(DbContext context) : base(context)
		{
			OnCreated();
		}
		...
		/// DbType = "TinyInt"
		/// </summary>
		public byte? GeoComponentType { get; set; }

		/// <summary>
		/// DbType = "TinyInt"
		/// </summary>
		public byte? GeoPrecisionType { get; set; }
		...
		/// <summary>
		/// DbType = "Int", DefaultValue = (int)(0)
		/// </summary>
		public int? GeoStatus { get; set; } = (int)(0);
	...
	#endregion dbo.tblDirGeolocation
