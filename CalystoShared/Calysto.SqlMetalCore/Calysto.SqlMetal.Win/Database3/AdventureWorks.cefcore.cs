...
namespace AdventureWorks.Database
{
	...
	public partial class AdventureWorksDataContext : DbContext
	{
		...
		private void Map_Sales_ContactCreditCard(ModelBuilder modelBuilder)
		{
			...
			modelBuilder.Entity<Sales_ContactCreditCard>().HasKey(x=>x.ContactID);
			modelBuilder.Entity<Sales_ContactCreditCard>().HasKey(x=>x.CreditCardID);
		...
		private void Map_Sales_CountryRegionCurrency(ModelBuilder modelBuilder)
		{
			...
			modelBuilder.Entity<Sales_CountryRegionCurrency>().HasKey(x=>x.CountryRegionCode);
			modelBuilder.Entity<Sales_CountryRegionCurrency>().HasKey(x=>x.CurrencyCode);
		...
		private void Map_Sales_CustomerAddress(ModelBuilder modelBuilder)
		{
			...
			modelBuilder.Entity<Sales_CustomerAddress>().HasKey(x=>x.CustomerID);
			modelBuilder.Entity<Sales_CustomerAddress>().HasKey(x=>x.AddressID);
		...
		private void Map_HumanResources_EmployeeAddress(ModelBuilder modelBuilder)
		{
			...
			modelBuilder.Entity<HumanResources_EmployeeAddress>().HasKey(x=>x.EmployeeID);
			modelBuilder.Entity<HumanResources_EmployeeAddress>().HasKey(x=>x.AddressID);
		...
		private void Map_HumanResources_EmployeeDepartmentHistory(ModelBuilder modelBuilder)
		{
			...
			modelBuilder.Entity<HumanResources_EmployeeDepartmentHistory>().HasKey(x=>x.EmployeeID);
			modelBuilder.Entity<HumanResources_EmployeeDepartmentHistory>().HasKey(x=>x.DepartmentID);
			modelBuilder.Entity<HumanResources_EmployeeDepartmentHistory>().HasKey(x=>x.ShiftID);
			modelBuilder.Entity<HumanResources_EmployeeDepartmentHistory>().HasKey(x=>x.StartDate);
		...
		private void Map_HumanResources_EmployeePayHistory(ModelBuilder modelBuilder)
		{
			...
			modelBuilder.Entity<HumanResources_EmployeePayHistory>().HasKey(x=>x.EmployeeID);
			modelBuilder.Entity<HumanResources_EmployeePayHistory>().HasKey(x=>x.RateChangeDate);
		...
		private void Map_Production_ProductCostHistory(ModelBuilder modelBuilder)
		{
			...
			modelBuilder.Entity<Production_ProductCostHistory>().HasKey(x=>x.ProductID);
			modelBuilder.Entity<Production_ProductCostHistory>().HasKey(x=>x.StartDate);
		...
		private void Map_Production_ProductDocument(ModelBuilder modelBuilder)
		{
			...
			modelBuilder.Entity<Production_ProductDocument>().HasKey(x=>x.ProductID);
			modelBuilder.Entity<Production_ProductDocument>().HasKey(x=>x.DocumentID);
		...
		private void Map_Production_ProductInventory(ModelBuilder modelBuilder)
		{
			...
			modelBuilder.Entity<Production_ProductInventory>().HasKey(x=>x.ProductID);
			modelBuilder.Entity<Production_ProductInventory>().HasKey(x=>x.LocationID);
		...
		private void Map_Production_ProductListPriceHistory(ModelBuilder modelBuilder)
		{
			...
			modelBuilder.Entity<Production_ProductListPriceHistory>().HasKey(x=>x.ProductID);
			modelBuilder.Entity<Production_ProductListPriceHistory>().HasKey(x=>x.StartDate);
		...
		private void Map_Production_ProductModelIllustration(ModelBuilder modelBuilder)
		{
			...
			modelBuilder.Entity<Production_ProductModelIllustration>().HasKey(x=>x.ProductModelID);
			modelBuilder.Entity<Production_ProductModelIllustration>().HasKey(x=>x.IllustrationID);
		...
		private void Map_Production_ProductModelProductDescriptionCulture(ModelBuilder modelBuilder)
		{
			...
			modelBuilder.Entity<Production_ProductModelProductDescriptionCulture>().HasKey(x=>x.ProductModelID);
			modelBuilder.Entity<Production_ProductModelProductDescriptionCulture>().HasKey(x=>x.ProductDescriptionID);
			modelBuilder.Entity<Production_ProductModelProductDescriptionCulture>().HasKey(x=>x.CultureID);
		...
		private void Map_Production_ProductProductPhoto(ModelBuilder modelBuilder)
		{
			...
			modelBuilder.Entity<Production_ProductProductPhoto>().HasKey(x=>x.ProductID);
			modelBuilder.Entity<Production_ProductProductPhoto>().HasKey(x=>x.ProductPhotoID);
		...
		private void Map_Purchasing_ProductVendor(ModelBuilder modelBuilder)
		{
			...
			modelBuilder.Entity<Purchasing_ProductVendor>().HasKey(x=>x.ProductID);
			modelBuilder.Entity<Purchasing_ProductVendor>().HasKey(x=>x.VendorID);
		...
		private void Map_Purchasing_PurchaseOrderDetail(ModelBuilder modelBuilder)
		{
			...
			modelBuilder.Entity<Purchasing_PurchaseOrderDetail>().HasKey(x=>x.PurchaseOrderID);
			modelBuilder.Entity<Purchasing_PurchaseOrderDetail>().HasKey(x=>x.PurchaseOrderDetailID);
		...
		private void Map_Sales_SalesOrderDetail(ModelBuilder modelBuilder)
		{
			...
			modelBuilder.Entity<Sales_SalesOrderDetail>().HasKey(x=>x.SalesOrderID);
			modelBuilder.Entity<Sales_SalesOrderDetail>().HasKey(x=>x.SalesOrderDetailID);
		...
		private void Map_Sales_SalesOrderHeaderSalesReason(ModelBuilder modelBuilder)
		{
			...
			modelBuilder.Entity<Sales_SalesOrderHeaderSalesReason>().HasKey(x=>x.SalesOrderID);
			modelBuilder.Entity<Sales_SalesOrderHeaderSalesReason>().HasKey(x=>x.SalesReasonID);
		...
		private void Map_Sales_SalesPersonQuotaHistory(ModelBuilder modelBuilder)
		{
			...
			modelBuilder.Entity<Sales_SalesPersonQuotaHistory>().HasKey(x=>x.SalesPersonID);
			modelBuilder.Entity<Sales_SalesPersonQuotaHistory>().HasKey(x=>x.QuotaDate);
		...
		private void Map_Sales_SalesTerritoryHistory(ModelBuilder modelBuilder)
		{
			...
			modelBuilder.Entity<Sales_SalesTerritoryHistory>().HasKey(x=>x.SalesPersonID);
			modelBuilder.Entity<Sales_SalesTerritoryHistory>().HasKey(x=>x.TerritoryID);
			modelBuilder.Entity<Sales_SalesTerritoryHistory>().HasKey(x=>x.StartDate);
		...
		private void Map_Sales_SpecialOfferProduct(ModelBuilder modelBuilder)
		{
			...
			modelBuilder.Entity<Sales_SpecialOfferProduct>().HasKey(x=>x.SpecialOfferID);
			modelBuilder.Entity<Sales_SpecialOfferProduct>().HasKey(x=>x.ProductID);
		...
		private void Map_Sales_StoreContact(ModelBuilder modelBuilder)
		{
			...
			modelBuilder.Entity<Sales_StoreContact>().HasKey(x=>x.CustomerID);
			modelBuilder.Entity<Sales_StoreContact>().HasKey(x=>x.ContactID);
		...
		private void Map_Purchasing_VendorAddress(ModelBuilder modelBuilder)
		{
			...
			modelBuilder.Entity<Purchasing_VendorAddress>().HasKey(x=>x.VendorID);
			modelBuilder.Entity<Purchasing_VendorAddress>().HasKey(x=>x.AddressID);
		...
		private void Map_Purchasing_VendorContact(ModelBuilder modelBuilder)
		{
			...
			modelBuilder.Entity<Purchasing_VendorContact>().HasKey(x=>x.VendorID);
			modelBuilder.Entity<Purchasing_VendorContact>().HasKey(x=>x.ContactID);
		...
		private void Map_Production_WorkOrderRouting(ModelBuilder modelBuilder)
		{
			...
			modelBuilder.Entity<Production_WorkOrderRouting>().HasKey(x=>x.WorkOrderID);
			modelBuilder.Entity<Production_WorkOrderRouting>().HasKey(x=>x.ProductID);
			modelBuilder.Entity<Production_WorkOrderRouting>().HasKey(x=>x.OperationSequence);
