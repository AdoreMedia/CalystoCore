...
{
	/// <summary>
	/// Ne koristiti ovo izdanje. Za stariji .net koristi varijatnu sa Threadovima, a za noviji .net core koristi varijantu sa IAsyncEnumerable, nalazi se u Calysto.Genesis.Tests projektu.
	/// </summary>
	public static class SelectParallelExtensions
	{
		...
		private static IEnumerable<TResult> SelectParallelWorker<TSource, TResult>(
		...
		public static IEnumerable<TResult> SelectParallel3<TSource, TResult>(
			this IEnumerable<TSource> items,
			Func<TSource, TResult> fnResultExecutor,
			int? parallelThreads = default,
			int? prefetchCount = default)
		{
			return items.SelectParallelWorker(fnResultExecutor, null, parallelThreads, prefetchCount);
		}
		...
		public static IEnumerable<TResult> SelectParallel3<TSource, TResult>(
			...
			int? prefetchCount = default)
		{
			return items.SelectParallelWorker(null, fnTaskExecutor, parallelThreads, prefetchCount);
		}
	}
}
