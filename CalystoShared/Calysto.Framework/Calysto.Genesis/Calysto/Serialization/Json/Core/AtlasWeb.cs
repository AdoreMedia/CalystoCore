namespace Calysto.Serialization.Json.Core
{
	...
	internal class AtlasWeb
    {
		...
		{
			public static string GetString(string str, object o)
			{
				return str;
			}
		}

        private static CultureInfo resourceCulture = null;
        ...
        internal static string ScriptManager_CannotRegisterPage
        {
            get
            {
                return ResourceManager.GetString("ScriptManager_CannotRegisterPage", resourceCulture);
            }
        }
        ...
        internal static string ScriptResourceHandler_AssemblyNotFileBased
        {
            get
            {
                return ResourceManager.GetString("ScriptResourceHandler_AssemblyNotFileBased", resourceCulture);
            }
        }
        ...
        internal static string UpdateProgress_TemplateRequired
        {
            get
            {
                return ResourceManager.GetString("UpdateProgress_TemplateRequired", resourceCulture);
            }
        }
