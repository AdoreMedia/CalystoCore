...
namespace Calysto.ISO7064
{
	...
	*/
	...
	public class CheckDigits
	{
		...
		private static string CalculateCheckDigit(string value, string charSet, bool doubleDigit)
		{
			int radix, modulus;
		...
		private static string CalculatePureSystemCheckDigit(string value, int radix, int modulus, string charSet, bool doubleDigit)
		{
		...
		private static string CalculateHybridSystemCheckDigit(string value, string charSet)
		{
			if (String.IsNullOrEmpty(value))
				return null;
		...
		/// </summary>
		private static bool VerifyCheckDigit(string value, string charSet, bool doubleDigit)
		{
			int radix, modulus;
			GetCheckDigitRadixAndModulus(charSet, doubleDigit, out radix, out modulus);
		...
		private static bool VerifyCheckDigit(string value, int radix, int modulus, string charSet, bool doubleDigit)
		{
