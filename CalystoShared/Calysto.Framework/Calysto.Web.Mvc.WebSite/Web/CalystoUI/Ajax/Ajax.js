            ...
            (function (Web) {
                ...
                (function (CalystoUI) {
                    ...
                    (function (Ajax) {
                        ...
                        function AjaxSend(sender) {
                            return __awaiter(this, void 0, void 0, function () {
                                ...
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, Ajax.AjaxService.AjaxSend(GetAjaxInputText(), GetAjaxInputFiles())
                        ...
                        Calysto.Page.OnUnhandledException(function (e) { return alert(e); });
                        function AjaxSendThrow(sender) {
                            return __awaiter(this, void 0, void 0, function () {
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, Ajax.AjaxService.AjaxSendThrow().ResultAsync()];
                                        case 1:
                                            _a.sent();
                                            return [2 /*return*/];
                                    }
                        ...
                        Ajax.AjaxSendThrow = AjaxSendThrow;
                        function AjaxSendDelayed(sender) {
                            var a1 = Ajax.AjaxService.AjaxSend(GetAjaxInputText(), GetAjaxInputFiles())
                                .OnProgress(function (e) { return console.log((e.IsUpload ? "upload" : "download") + ": " + e.Percent + " % of " + e.Total + " bytes"); })
                                .OnSuccess(function (resp) { return console.log(resp); });
                        ...
                        function SendClientDateTime(sender) {
                            Ajax.AjaxService.SendClientDateTime(new Date())
                                .OnSuccess(function (resp) {
                        ...
                        function SendResultAsync(sender) {
                            return __awaiter(this, void 0, void 0, function () {
                                ...
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, Ajax.AjaxService.SendClientDateTime(new Date()).ResultAsync()];
                                        case 1:
                                            res1 = _a.sent();
                        ...
                        function AjaxVoidAsync(sender) {
                            return __awaiter(this, void 0, void 0, function () {
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, Ajax.AjaxService.Javascript1()];
                                        case 1:
                                            _a.sent();
                                            return [2 /*return*/];
                                    }
                        ...
                        Ajax.AjaxVoidAsync = AjaxVoidAsync;
