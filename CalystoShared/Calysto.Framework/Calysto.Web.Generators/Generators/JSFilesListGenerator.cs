...
//{
//	public class JSFilesListGenerator
//	{
//		string _destinationFile = EnvDTECalystoWeb.ProjectDir + "_generated\\JSFilesList.cs";
//		string _projectRoot = EnvDTECalystoWeb.ProjectDir;
//		string _mapDirectory = "WebLib";

//		public void GenerateCalystoWebJSFilesList()
//		{
...
//			var files = Directory.EnumerateFiles(_projectRoot + _mapDirectory, "*.js", SearchOption.AllDirectories)
...
//				.Replace(".js", "").Trim('.', ',', '/', '\\', ' ').Replace(".", "_").Replace("/", "_").Replace("\\", "_").Replace("-", "_");
//		}
...
//{{
//	internal static class JSFilesList
//	{{
