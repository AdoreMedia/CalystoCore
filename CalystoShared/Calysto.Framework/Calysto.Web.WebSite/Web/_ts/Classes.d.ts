...
declare namespace Calysto.Web.TestSite.Web.CalystoUI.Ajax
{
	...
	namespace AjaxService
	{
		...
		export function DownloadBinaryFrameObject(): Calysto.Net.WebService.AjaxServiceClientWithReturn<Calysto.Web.TestSite.Web.CalystoUI.Ajax.AjaxService.BinaryFrameObj>;
...
declare namespace Calysto.Web.TestSite.Web.CalystoUI.Ajax.AjaxService
{
