...
namespace DllUnitTest
{
    ...
    {
        private static TestDirectoryService _directoryService = new TestDirectoryService(EnvDteDllUnitTest.ProjectDir, "TestData\\Dll\\SourceDirective\\");
        ...
        public void SourceChange()
        {
            ...
            // get the source code
            string source;
            var inputPath = _directoryService.CreateFilePath(o => o.InputDirectory, FileName);
            Trace.Write("Source: ");
            ...
            string expected;
            var expectedPath = new FileInfo(_directoryService.CreateFilePath(o => o.ExpectedDirectory, FileName));
            ...
            if (!Directory.Exists(_directoryService.OutputDirectory))
            {
                Directory.CreateDirectory(_directoryService.OutputDirectory);
            }

            var actualPath = new FileInfo(_directoryService.CreateFilePath(o => o.OutputDirectory, FileName));
            Trace.Write("Actual: ");
