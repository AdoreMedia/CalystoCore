    ...
    public class ResolutionVisitor : IVisitor
    {
        ...
        private static void ResolvePredefinedGlobal(Lookup lookup, ActivationObject scope, CodeSettings settings)
        {
            if (lookup.Name.Length == 6 && string.CompareOrdinal(lookup.Name, "window") == 0)
            {
                ...
                else
                {
                        ...
                        && callNode.Arguments[0].FindPrimitiveType() == PrimitiveType.String)
                    {
                        ...
                        // maybe: we could get rid of the ConstantWrapper restriction and use an Evaluate visitor
                ...
                && lookup.Name.Length == 4 && string.CompareOrdinal(lookup.Name, "eval") == 0)
            {
                ...
                // maybe: what if we are assigning it to a variable? Should we track that variable and see if we call it?
        ...
        private static void ResolveGhostedCatchParameter(ActivationObject scope, BindingIdentifier catchBinding)
        {
            ...
            if (catchBinding != null)
            {
                ...
                // maybe: this really should be a LIST of ghosted fields, since multiple 
        ...
        public void Visit(ComprehensionNode node)
        {
            if (node != null)
            {
                ...
                // maybe: throw a warning if there's nothing defined in this scope, because there
            ...
            if (node != null)
            {
                ...
                else if (!node.ModuleName.IsNullOrWhiteSpace())
                {
                    ...
                    if (node.Count == 0)
                    {
                        ...
                        // maybe: try resolving the module, and if we can, use its exports to add to our exports.
                        if (moduleScope != null)
                        {
                    ...
                    else
                    {
                        ...
                        // maybe: add the specifiers to the exports of this module
                    }
                }
                else
                {
                    ...
                    // export function ...
                    // export class ...
                    // maybe: add the references or definitions to the export list for the module
        ...
        public void Visit(ParameterDeclaration node)
        {
            if (node != null)
            {
                ...
                // maybe: what about initializers INSIDE the bindings?
