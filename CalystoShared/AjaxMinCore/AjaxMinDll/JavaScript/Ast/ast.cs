...
namespace Microsoft.Ajax.Utilities
{
    ...
    public abstract class AstNode
    {
        ...
        private static readonly List<AstNode> s_emptyChildrenCollection = new List<AstNode>();
        ...
        /// </summary>
        public virtual List<AstNode> Children
        {
        ...
        internal static List<AstNode> FastEnumerateNonNullNodes<T>(IList<T> nodes) where T : AstNode
        {
            var hasNull = false;
            ...
            if (hasNull)
            {
                return EnumerateNonNullNodes(nodes).ToList();
            }

            // Return the original list, avoid allocation using yield return
            return ((IEnumerable<AstNode>)nodes).ToList();
        }
        ...
        internal static List<AstNode> EnumerateNonNullNodes(AstNode n1, AstNode n2 = null, AstNode n3 = null, AstNode n4 = null)
        {
            return EnumerateNonNullNodes(new[] { n1, n2, n3, n4 }).ToList();
        }
